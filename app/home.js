...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f5b4d2', justifyContent: 'center', alignItems: 'center', padding: 20 },
  ...
  greet: { fontSize: 20, color: '#dc82a0' },
  ...
  footer: { color: '#ed7b9f', fontSize: 12, position: 'absolute', bottom: 100 },
